...
testpos=np.random.randn(5,2,3) #2x3x5 dimensional array of random numbers plucked from a normal distn (mean = 0, stdev = 1)
swappos = np.swapaxes(testpos,0,2) #CHECK that this does what I think it does
print(testpos.shape)
print(swappos.shape)
